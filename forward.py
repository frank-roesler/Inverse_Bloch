...
(model, B1, G, target_z, target_xy, slice_centers, half_width, fixed_inputs) = load_data(path, mode="inference")
...
with torch.no_grad():
    ...
    # plot_timeprof(fixed_inputs, B1, G, fixed_inputs, slice_centers, path=path, fig=None, ax=None)
