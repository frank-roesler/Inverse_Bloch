...
target_z, target_xy, slice_centers = get_smooth_targets(theta=flip_angle, smoothness=3.0, function=torch.sigmoid, n_targets=n_slices)
...
with torch.no_grad():
    ...
    plot_some_b0_values(npts_some_b0_values, pos, sens, G, B1 + 0j, B0, M0, target_xy, target_z, t_B1, dt)
    plot_timeprof(gamma, B1, G, pos, sens, B0_list, M0, dt, t_B1, slice_centers)
