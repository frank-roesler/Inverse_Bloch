...
ax[1, 0].plot(inputs["pos"], np.real(mz.detach().cpu().numpy()), linewidth=0.8)
ax[1, 0].plot(inputs["pos"], target_z, linewidth=0.8)
ax[1, 1].plot(inputs["pos"], np.abs(mxy.detach().cpu().numpy()), linewidth=0.8)
ax[1, 1].plot(inputs["pos"], target_xy, linewidth=0.8)
