...
B1, G, target_z, target_xy, _ = load_data(path)
...
(model, _, _, optimizer, losses, _, flip_angle, loss_metric, scanner_params, loss_weights, start_epoch) = load_data(path, mode="train")
