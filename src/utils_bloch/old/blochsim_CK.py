...
def blochsim_CK(B1, G, pos, sens, B0_list, M0, **kwargs):
    """
    Bloch Simulator using Cayley-Klein parameters for multiple voxels simultaneously.
    ...
    **kwargs : dict
    ...
    if returnallstate:
        ...
        return mxy, mz, mxyt, mzt, a, b

    return mxy.unsqueeze(0), mz.unsqueeze(0)
